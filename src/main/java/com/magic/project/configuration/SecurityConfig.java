...
//    	http.cors();
   	http
        ...
        .antMatchers(HttpMethod.POST, "/hospital/doctor/add", "/hospital/receptionist/add", "/hospital/medicine/add", "/hospital/medicalTest/add").hasRole("Admin")
        .antMatchers(HttpMethod.DELETE, "/hospital/doctor/delete", "/hospital/receptionist/delete", "/hospital/patient/delete", "/hospital/appointment/delete", "/hospital/prescription/delete","/hospital/medicalTest/delete", "/hospital/medicine/delete").hasRole("Admin")
        .antMatchers(HttpMethod.POST, "/hospital/appointment/add", "/hospital/patient/add").hasAnyRole("Admin", "Receptionist")
        .antMatchers(HttpMethod.PATCH,"/hospital/user/update/password/**", "/hospital/appointment/update/status/**", "/hospital/prescription/update/test/**", "/hospital/medicine/update/quantity/**", "/hospital/medicalTest/update/price/**").hasAnyRole("Doctor", "Receptionist", "Admin")
        .antMatchers(HttpMethod.PUT, "/hospital/doctor/update/**", "/hospital/receptionist/update/**").hasRole("Admin")
        .antMatchers(HttpMethod.PUT, "/hospital/appointment/update/**", "/hospital/patient/update/**",  "/hospital/prescription/update/**", "/hospital/medicine/update/**", "/hospital/medicalTest/update/**" ).hasAnyRole("Admin", "Receptionist")
        ...
        .antMatchers("/hospital/prescription/**").hasAnyRole("Doctor", "Receptionist", "Admin")
        .antMatchers("/hospital/medicalTest/**").hasAnyRole("Doctor", "Receptionist", "Admin")
        .antMatchers("/hospital/medicine/**").hasAnyRole("Doctor", "Receptionist", "Admin")
